...
public class MessageHandler {
    ...
    public MessageHandler(LocaleService localeService, MessageSender messageSender, MainMenuService menuService, SelectOneService selectOneService, SelectAllService selectAllService, SearchService searchService, AboutService aboutService, CompareService compareService, AllParamsService allParamsService, StepServiceImpl stepService, CustomParamsService customParamsService, CombinationService combinationService) {
