...
public class WebhookController {
    ...
    public WebhookController(PvlVuzyBot bot, StepServiceImpl stepService, LocaleService localeService, UpdateCounterService updateCounterService) {
        this.bot = bot;
    ...
    public String getLangs(Model model) {
        return localeService.getMap().toString();
    }
